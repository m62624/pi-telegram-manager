...
open it — acknowledge what they wrote and offer help. Deliver it with `manager_reply` (or, if the directive says a draft of it is held, with `manager_resolve_draft`),
